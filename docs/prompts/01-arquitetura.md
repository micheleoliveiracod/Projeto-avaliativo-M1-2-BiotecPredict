...
- Arquitetura em camadas: API (FastAPI) → Services → Repositories → Database (PostgreSQL)
...
Stack definida: FastAPI 0.104 + React 18 + PostgreSQL 15 + scikit-learn 1.3 + pytest + Vitest + Cypress + GitHub Actions.
