...
4. Configure banco de dados PostgreSQL como service para os testes de integração
...
Workflow `ci.yml` com 4 jobs paralelos: `backend-lint`, `backend-tests` (com PostgreSQL service), `frontend-lint`, `frontend-tests`. Cache configurado para pip e npm.
