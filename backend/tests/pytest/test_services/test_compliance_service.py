...
class TestComplianceService:
    ...
    def test_warning_score(self):
        """Score com todos os sensores próximos dos limites aceitáveis deve retornar WARNING."""
        sensor_readings = [
            {
                "temperature": 29.5,   # Próximo do limite máximo aceitável (30°C)
                "ph": 6.5,             # Exatamente no limite mínimo aceitável
                "dissolved_oxygen": 71.0,  # Próximo do limite mínimo aceitável (70%)
                "pressure": 5.9,       # Próximo do limite máximo aceitável (6.0 bar)
                "agitator_speed": 290, # Próximo do limite máximo aceitável (300 RPM)
            }
        ]
