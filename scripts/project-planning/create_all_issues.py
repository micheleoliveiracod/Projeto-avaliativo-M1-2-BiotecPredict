...
IMPORTANTE - Política de CI/CD (ATUALIZADA):
- ✅ Testes disparam APENAS APÓS aprovação do PR em branches: feature/*, bugfix/*, hotfix/*
...
LABELS = [
    ...
    {"name": "backend", "color": "0052CC", "description": "Alterações no backend Python/FastAPI"},
    ...
    {"name": "database", "color": "FFA500", "description": "Alterações no banco de dados"},
    {"name": "api", "color": "003366", "description": "Alterações na API REST"},
    
    # Tipo de trabalho
    {"name": "testing", "color": "FFD700", "description": "Testes e cobertura"},
    {"name": "documentation", "color": "808080", "description": "Documentação"},
    {"name": "bug", "color": "DC143C", "description": "Correção de bugs"},
    {"name": "feat", "color": "00CED1", "description": "Novas funcionalidades"},
    {"name": "chore", "color": "A9A9A9", "description": "Tarefas de manutenção"},
    
    # Sprints
    {"name": "sprint-1", "color": "1F77B4", "description": "Issues do Sprint 1"},
    {"name": "sprint-2", "color": "FF7F0E", "description": "Issues do Sprint 2"},
    {"name": "sprint-3", "color": "2CA02C", "description": "Issues do Sprint 3"},
    {"name": "sprint-4", "color": "D62728", "description": "Issues do Sprint 4"},
    {"name": "sprint-5", "color": "9467BD", "description": "Issues do Sprint 5"},

    # Adicionais
    {"name": "setup", "color": "E83E8C", "description": "Setup e configuração"},
    {"name": "ci", "color": "17A2B8", "description": "CI/CD e automação"},
    {"name": "refactor", "color": "6C757D", "description": "Refatoração de código"},
    {"name": "style", "color": "20C997", "description": "Formatação e estilo"},
    {"name": "perf", "color": "FFC107", "description": "Melhoria de performance"},
    {"name": "entrega-final", "color": "8B008B", "description": "Requisitos de entrega final"},
    {"name": "rastreamento", "color": "4B0082", "description": "Rastreamento de progresso"},
    {"name": "checklist", "color": "FF1493", "description": "Checklist de tarefas"},
]
...
feature/project-structure"""
    ...
    {
        "title": "setup: configurar banco de dados SQLite e ORM",
        "labels": ["setup", "database", "backend", "sprint-0"],
        "milestone": "Sprint 0 - Setup",
        "body": """## Contexto
Configurar SQLAlchemy e conexao com SQLite

## Escopo
- Criar modelos SQLAlchemy (Batch, SensorReading, Prediction)
- Implementar repository pattern
- Configurar conexao com SQLite
